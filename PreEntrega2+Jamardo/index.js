...
if (curHr >= 6 && curHr < 13) {
    alert('Buenos Días, Bienvenidos a Nuestra de comida Online!')
} else if (curHr >= 13 && curHr < 21) {
    alert('Buenas Tardes, Bienvenidos a Nuestra de comida Online!')
} else if (curHr >= 21 && curHr < 6) {
    alert('Buenas Noches, Bienvenidos a Nuestra de comida Online!')
}
...
// creamos  productos
const hamburguesa = new Producto('pizza', 'Pizza Napolitana', 2100, 20)
const bebida = new Producto('gaseosa', 'Coca Cola 3L', 380, 20)
const helado = new Producto('helado', '1/4 Chocolate Mani Crunch', 700, 10)
